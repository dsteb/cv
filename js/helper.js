...
var HTMLworkEmployer = '<a href="#" target="_blank" class="block">%data%';
...
var HTMLprojectTitle = '<a href="#" target="_blank" class="block">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p>%data%</p>';
var HTMLprojectImage = '<a href="#" target="_blank"><img src="%data%" class="project-img"></a>';

var HTMLschoolStart = '<div class="education-entry clear"></div>';
var HTMLschoolName = '<a href="#" target="_blank" class="block">%data%';
...
var HTMLonlineTitle = '<a href="#" target="_blank" class="block">%data%';
